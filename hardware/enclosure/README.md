...
3D-printed two-piece case (magnet-held lid) sized for the "D1 Mini ESP32" board (ESP32-WROOM-32
module, no mounting holes), the W5500 Ethernet breakout, and the SparkFun MAX-M10S GPS module, as
...
- **ESP32**: no screws -- held by a friction-fit cradle.
- **GPS module**: 4x M3x6 button head screws.
- **W5500 breakout**: 2x M3x6 button head screws, plus a rear clip molded into the case.

## Magnets

Each half has four embedded holes for 6x2mm magnets (6mm diameter, 2mm thick; eight magnets
total), used to hold the lid closed:
